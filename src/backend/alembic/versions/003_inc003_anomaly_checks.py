...
def upgrade() -> None:
    ...
    op.bulk_insert(
        ...
        [
            ...
            {
                "id": 4, "key": "forensics", "weight": 15.0, "enabled": True,
                "severity": "medium",
                "name": "Forensic pricing anomaly (round-number bias / predetermined price)",
                "basis": "ACFE / World Bank — Benford's Law & round-number analysis",
            },
            {
                "id": 5, "key": "supplier_net", "weight": 10.0, "enabled": True,
                "severity": "medium",
            ...
            {
                "id": 6, "key": "score_var", "weight": 5.0, "enabled": True,
                "severity": "low",
                "name": "Award value significantly exceeds tender estimate",
                "basis": "ZPPA guidelines — award-over-estimate ratio signals budget gaming",
            },
            {
                "id": 7, "key": "amendment", "weight": 10.0, "enabled": True,
                "severity": "medium",
            ...
            {
                "id": 8, "key": "debarment", "weight": 10.0, "enabled": True,
                "severity": "high",
