  ...
  theme: {
    extend: {
      colors: {
        ...
        sidebar: "#0B1F1A", "sidebar-2": "#13302A",
        "sidebar-text": "#E7EFEA", "sidebar-muted": "#8FA89C",
      },
      fontFamily: {
      ...
      borderRadius: { DEFAULT: "0.5rem", lg: "0.5rem", xl: "0.75rem", "2xl": "1rem" },
    },
  },
  plugins: [],
}
